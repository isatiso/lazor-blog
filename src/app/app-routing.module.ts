...
const routes: Routes = [
    { path: 'home', loadChildren: './modules/home/home.module#HomeModule', data: { title: 'home', scrollLimit: 0 } },
    ...
    { path: 'index', loadChildren: './modules/index/index.module#IndexModule', data: { title: 'index', scrollLimit: 276 } },
