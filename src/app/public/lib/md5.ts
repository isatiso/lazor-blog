...
export class MD5 {
    ...
    hex_md5(s) {
        return this.binl2hex(
            this.core_md5(
                this.str2binl(s), s.length * this.chrsz));
    }
    b64_md5(s) {
    ...
    md5_cmn(q, a, b, x, s, t) {
        return this.safe_add(
            this.bit_rol(
                this.safe_add(this.safe_add(a, q), this.safe_add(x, t)), s), b);
    }
    ...
    core_hmac_md5(key, data) {
        ...
        const hash = this.core_md5(
            ipad.concat(this.str2binl(data)), 512 + data.length * this.chrsz);
